...
let segundoDisplay = document.getElementById("segundos");
...
function atualizarDisplay(){
    minutosDisplay.textContent = minutos.toString().padStart(2,"0"); //String é pra converter em texto, ja o padStart server para mudar o carácter0
    segundoDisplay.textContent = segundos.toString().padStart(2,"0");
}
